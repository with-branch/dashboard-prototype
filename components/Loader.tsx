...
export default function Loader() {
    return (
        <div id="loader" className="loader bg-tertiary h-screen w-screen">
            <svg className="pl relative mx-auto top-1/3" viewBox="0 0 200 200" width="200" height="200" xmlns="http://www.w3.org/2000/svg">
                <defs>
